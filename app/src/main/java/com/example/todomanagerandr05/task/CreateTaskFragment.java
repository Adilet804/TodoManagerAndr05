    ...
    public void onViewCreated(@NotNull View view, @Nullable @org.jetbrains.annotations.Nullable Bundle savedInstanceState) {
        ...
        binding.applyBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                TaskModel model = new TaskModel(R.color.purple_200,userTask,userChoosedDate +"/"+time,"https://go.mail.ru/search_images?fr=ps&frm=main&q=jojo&gp=843253&src=go&sbmt=1634633589346&hasnavig=0#urlhash=6830536105217900409");
